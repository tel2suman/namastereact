            ...
            <div className="mt-8 overflow-hidden">
                <div className="grid grid-cols-1 md:grid-cols-2">
                    <div className="p-6 mr-2 bg-yellow-50  sm:rounded-lg">
                        <h1 className="text-4xl sm:text-5xl text-gray-800 dark:text-lime-600 font-extrabold tracking-tight">
                            Get in touch
                        </h1>
                    ...
                    <form className="p-6 flex flex-col justify-center">
                        ...
                        <button type="submit" className="md:w-32 bg-amber-600 hover:bg-lime-600 text-white font-bold py-3 px-6 rounded-lg mt-3 transition ease-in-out duration-300">
                            Submit
                        </button>
                    </form>
                </div>
